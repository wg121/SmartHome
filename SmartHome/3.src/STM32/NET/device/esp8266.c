...
/*
#define ESP8266_WIFI_INFO		"AT+CWJAP=\"wifi的名字\",\"wifi密码\"\r\n"

#define ESP8266_ONENET_INFO		"AT+CIPSTART=\"TCP\",\"点分十进制IP\",端口号\r\n"
*/
...
#define WIFI_SSID 						"test"								//	WIFI的名称 必须用2.4G的wifi不能用5G的，且不能用中文、空格
#define WIFI_PSWD 						"w20010108."				  //	WIFI密码
...
extern u8 ESP8266_INIT_OK;//esp8266初始化完成标志
...
void ESP8266_Init(void)
{
	...
	GPIO_Initure.GPIO_Pin = GPIO_Pin_8;					//GPIOC14-复位
